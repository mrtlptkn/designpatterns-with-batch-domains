...
public interface IStepCommand {
    void execute(StepExecution stepExecution); // bir davranış hesaplama, bir kod bloğu çalıştırma, bir akış içerisine bir komut eklemek, bir davranış eklemek için kullanıyoruz.
